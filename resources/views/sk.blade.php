    ...
    <div class="row">
      ...
      <div class="card ">
        ...
        <div class="card-body justify-content-center">
          <p style="font-style: normal; font-size:20px;">Sebagai Irjen yang telah menjabat sejak tahun 2009 hingga 2013 dengan capaian prestasi 5,5 sks/smt, saya telah melibatkan diri aktif dalam berbagai proyek pengabdian masyarakat. Untuk mendukung informasi ini, silakan temukan Nomor SK Penugasan saya yang dapat diakses pada lampiran SK Penugasan dan Bukti Kinerja (SKTMT). Saya berkomitmen untuk terus berkontribusi dalam pengabdian masyarakat melalui dedikasi dan pengalaman saya selama bertahun-tahun.</p>
          <button class="btn btn-primary">Download SK</button>
          <!-- <a href="#" class="btn btn-primary">Upload</a>
            <a href="#" class="btn btn-danger">Hapus Jurnal</a> -->
        </div>
      </div>
