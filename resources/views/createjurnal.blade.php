                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('jurnal.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="judul_jurnal" class="form-control" id="judul_jurnal" required>
                            </div>
                            <div class="mb-3">
                                <label for="isi" class="form-label">Nama Penulis</label>
                                <textarea name="namapenulis" class="form-control" id="namapenulis" required></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="gambar" class="form-label">Tgl Publikasi</label>
                                <input type="text" name="tanggalpublikasi" class="form-control" id="tanggalpublikasi" required>
                            </div>

                            <div class="mb-3">
                                <label for="gambar" class="form-label">Bahasa</label>
                                <input type="text" name="bahasa" class="form-control" id="bahasa" required>
                            </div>

                            <div class="mb-3">
                                <label for="gambar" class="form-label">Upload Jurnal disini</label>
                                <input type="file" name="file_name" class="form-control" id="file_name" required>
                            </div>
                            <button type="submit" class="btn btn-primary">Simpan</button>
                            <a href="{{ route('viewsjurnal') }}" class="btn btn-primary">List Jurnal</a>
                        </form>
                    </div>
                </div>
            </div>
