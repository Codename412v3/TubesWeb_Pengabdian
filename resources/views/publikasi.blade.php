...
<body>
  <nav class="navbar navbar-light">
    ...
    <a class="btn btn-primary" href="{{ url('/main') }}">Home</a>
  ...
  <div class="container mt-4">
    <div class="row">
      <div class="col-md-6 mb-4">
        ...
        <a style="color:black;" href="{{ route('daftarjurnal') }}">
          <div class="card custom-card">
            <img class="card-img-top" src="{{ asset('gambar/coursel.png') }}" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Cek Publikasi</h5>
              <p class="card-text">Info Selengkapnya Klik Menu Ini</p>
      ...
      <div class="col-md-6 mb-4">
        <div class="card custom-card">
          <img class="card-img-top" src="{{ asset('gambar/coursel.png') }}" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">Ajukan Publikasi</h5>
            <p class="card-text">Info Selengkapnya Klik Menu Ini</p>
